...
const aboutData = {
  cvpath: "media/CV Plus Portfolio.pdf",
  image: "images/140logo.png",
  name: "Chahyo Purnomo Aji",
  location: "Jakarta, Indonesia",
  phone: "+62 85161052522",
  email: "cp@aji.biz.id - ajizblast@gmail.com",
  aboutMe:
    "I am Chahyo Purnomo Aji,fullstack web developer and ui/ux designer from Jakarta, Indonesia. I have extensive experience in designing, building, and customizing websites, with proficiency in React.js, Golang, Java Springboot, and Figma.",
};
